...
use Cake\ElasticSearch\Exception\MissingBehaviorException;
use LogicException;
...
class BehaviorRegistry extends ObjectRegistry implements EventDispatcherInterface
{
     ...
     * Constructor
     *
     * @param \Cake\ElasticSearch\Type|null $type The type this registry is attached to.
     */
    ...
    /**
     * Attaches a type instance to this registry.
     *
     * @param \Cake\ElasticSearch\Type $type The type this registry is attached to.
     * @return void
     */
    public function setType(Type $type)
    {
        $this->_type = $type;
        $eventManager = $type->getEventManager();
    ...
    public static function className($class)
    {
        ...
        if (!$result) {
            $result = App::className($class, 'ElasticSearch/Behavior', 'Behavior');
        }
    ...
    {
        $instance = new $class($this->_type, $config);
